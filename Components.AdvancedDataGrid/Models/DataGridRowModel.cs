...
namespace Components.AdvancedDataGrid.Models
{
    public class DataGridRowModel : INotifyPropertyChanged
    {
        ...
        // OPRAVENÉ - explicitne definuje default value namiesto default(T)
        ...
        {
            IsEmpty = Cells.Values.All(c => c.ColumnName == "DeleteAction" || c.ColumnName == "ValidAlerts" ||
                                           c.Value == null || string.IsNullOrWhiteSpace(c.Value?.ToString()));
        }
